...
function widget:Initialize()
	...
	Spring.SetConfigInt("MaxParticles",45000,false)
	Spring.SetConfigInt("MaxNanoParticles",20000,false)
	Spring.SendCommands("grounddetail 140")	
	Spring.SetConfigInt("GroundDecals",2,false)
	-- Spring.SetConfigInt("GroundScarAlphaFade",1,false) -- apparently it's read only
