...
local advCommanderDefIds = {
	...
	[UnitDefNames['aven_u8commander'].id] = true,
	...
	[UnitDefNames['gear_u8commander'].id] = true,
	...
	[UnitDefNames['claw_u8commander'].id] = true,
	...
	[UnitDefNames['sphere_u8commander'].id] = true
}
