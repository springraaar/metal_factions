function gadget:GetInfo()
	return {
		...
		date = "06/05/2013, modified by raaar 2025+",
...
if gadgetHandler:IsSyncedCode() then
	...
	local tooltipText = 'Set Target: Attack when within range, ignoring movement'
	...
	function gadget:Initialize()
		...
		Spring.SetCustomCommandDrawData(CMD_UNIT_SET_TARGET_RECTANGLE, "settargetrectangle", queueColour, true)
